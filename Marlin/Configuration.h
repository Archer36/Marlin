...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST { 24.23360, 26.82 }
    #define DEFAULT_Ki_LIST { 2.11832, 2.31 }
    #define DEFAULT_Kd_LIST { 69.30810, 77.78 }
  #else
    #define DEFAULT_Kp 20.15
    #define DEFAULT_Ki 1.75
    #define DEFAULT_Kd 58.02
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 99.31
  #define DEFAULT_bedKi 15.52
  #define DEFAULT_bedKd 423.74
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 82.01, 80.81, 402.82001, 410.97247, 93 }  // non-standard z and e for bondtech and belted z
