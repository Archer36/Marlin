...
#define CUSTOM_MACHINE_NAME "Ender-3 IDEX"
...
#define HOTEND_OFFSET_X { 0.0, 6.00 } // (mm) relative X-offset for each nozzle
#define HOTEND_OFFSET_Y { 0.0, -5.30 }  // (mm) relative Y-offset for each nozzle
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST { 26.55171, 35.60197 }
    #define DEFAULT_Ki_LIST { 2.30484, 4.45025 }
    #define DEFAULT_Kd_LIST { 76.46893, 71.20394 }
  #else
    #define DEFAULT_Kp 26.55171
    #define DEFAULT_Ki 2.30484
    #define DEFAULT_Kd 76.46893
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 119.56185
  #define DEFAULT_bedKi 17.58262
  #define DEFAULT_bedKd 542.01379
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 400, 410.97247, 93 }  // non-standard z and e for bondtech and belted z
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 2000, 2000, 5, 45, 25 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 100, 1000, 5000 }
...
#define Y_MIN_POS -15
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE  // Max position limited due to IDEX printhead
