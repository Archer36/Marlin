...
#define DUAL_X_CARRIAGE
  ...
  #define X2_MIN_POS    61      // A min coordinate so the X2 carriage can't hit the parked X1 carriage
  #define X2_MAX_POS   273        // The max position of the X2 carriage, typically also the home position
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  27.58          // (Hz) The default dominant resonant frequency on the X axis.
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.0, 0.0 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
